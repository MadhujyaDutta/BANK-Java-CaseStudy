...
//		Previous Objects
		MMCurrentAcc cAcc = new MMCurrentAcc(1011, "Mohan", accBal, creditLimit);
		MMSavingAcc sAcc = new MMSavingAcc(1056, "Madhujya", accBal, true);
...
//				CURRENT ACCOUNT Object Creation
				...
				case 1:
					...
					System.out.println("CREDIT LIMIT: " + "Madhujya");
					break;
				case 2:
					System.out.println("Enter Ammount:");
					amt = sc.nextFloat();
